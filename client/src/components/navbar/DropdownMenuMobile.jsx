...
export default function DropdownMenuMobile({ isMenuOpen, handleNavigation }) {
  ...
  return (
    <div
      className={`absolute top-full left-0 w-screen h-screen bg-midnightBlack text-offwhite transform transition-all duration-500 ease-in-out flex flex-col items-center justify-center gap-20 text-center z-50 ${
        isMenuOpen
