...
function StatCard({ value, label, suffix, delay }) {
  return (
    ...
    >
      <motion.p className="text-3xl lg:text-5xl font-bold text-offwhite mb-2">
...
export default function StatisticsSection() {
  ...
  return (
    <section className="py-24 px-6 bg-gradient-to-r from-emerald-500 to-teal-600 full-width-section">
